  ...
  const GetAllPromotions = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetAllPromotions endpoint is not yet implemented",
      );
    } catch (error) {
  ...
  const GetPromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetPromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const CreatePromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "CreatePromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const UpdatePromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "UpdatePromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const DeactivatePromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "DeactivatePromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const ActivatePromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "ActivatePromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const DeletePromotion = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "DeletePromotion endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const GetPromotionRequests = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetPromotionRequests endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const DeletePromotionRequest = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "DeletePromotionRequest endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const GetPromotionStats = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetPromotionStats endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const GetPromotionForAd = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetPromotionForAd endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
