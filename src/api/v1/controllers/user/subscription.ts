  ...
  const GetSubscriptionPlans = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetSubscriptionPlans endpoint is not yet implemented",
      );
    } catch (error) {
  ...
  const GetSubscriptionPlan = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetSubscriptionPlan endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const Subscribe = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "Subscribe endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const PayForSubscription = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "PayForSubscription endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const VerifyPayment = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "VerifyPayment endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const CancelSubscription = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "CancelSubscription endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const GetSubscriptionStatus = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetSubscriptionStatus endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
  ...
  const GetSubscriptionHistory = async (req: Request, res: Response) => {
    try {
      return sendErrorFeedback(
        res,
        501,
        "GetSubscriptionHistory endpoint is not yet implemented",
      );
    } catch (error) {
      return sendCatchFeedback(
        res,
